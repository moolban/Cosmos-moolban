...
@objc public class CosmosSettingsObjCBridge: NSObject {
     ...
     */
    @objc(setUpdateOnTouch:inCosmosView:)
     ...
     */
    @objc(setTotalStars:inCosmosView:)
     ...
     */
    @objc(setStarMargin:inCosmosView:)
     ...
     */
    @objc(setFilledColor:inCosmosView:)
     ...
     */
    @objc(setEmptyColor:inCosmosView:)
     ...
     */
    @objc(setFilledBorderWidth:inCosmosView:)
     ...
     */
    @objc(setFilledBorderColor:inCosmosView:)
     ...
     */
    @objc(setEmptyBorderWidth:inCosmosView:)
     ...
     */
    @objc(setEmptyBorderColor:inCosmosView:)
     ...
     */
    @objc(setTextColor:inCosmosView:)
     ...
     */
    @objc(setTextMargin:inCosmosView:)
    ...
    @objc(isStarAnimation:inCosmosView:)
    public class func isStarAnimation(_ value: Bool, inCosmosView cosmosView: CosmosView) {
        cosmosView.settings.isStarAnimation = value;
    }
    
    @objc(didFinishTouchingCosmos:inCosmosView:)
    public class func didFinishTouchingCosmos(_ sel: @escaping ((Double)->()), inCosmosView cosmosView: CosmosView) {
        cosmosView.didFinishTouchingCosmos = sel;
    }
}
